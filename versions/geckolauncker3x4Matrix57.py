...
"""
THE VERSIONS > [v.5.0] ARE REALLY GECKOSTABLES!!!
"""
...
# organizadas en un diccionario... 

# --- ejemplo de ~/.config/gecko_lanzadoresv3x4.json
"""
{
    "version": "v.4.3",
    ...
    "categorias": {
        "🦎 GeckoLauncher": {
            ...
            "tema": {
                ...
                "color_fondo_item_activo": "#00aa00",
                "color_texto_item_activo": "#ffffff"
            }
        },
        "SETINGS": {
            "items": [
                {
                    ...
                    "huevo": true,
                    "nombre": "hmx.py",
                    "ruta": "/home/alan/Visual Studio Python/GeckoLauncher/hmx.py"
                },
                {
                    "consola": false,
                    "nombre": "geckolink_subsystemconfig.sh",
                    "ruta": "/home/alan/Visual Studio Python/GeckoLauncher/GeckoLinks/geckolink_subsystemconfig.sh"
                },
                {
                    "consola": false,
                    "nombre": "geckolink_pavucontrol.sh",
                    "ruta": "/home/alan/Visual Studio Python/GeckoLauncher/GeckoLinks/geckolink_pavucontrol.sh"
                },
                {
                    "consola": false,
                    "nombre": "geckolink_displaysettings.sh",
                    "ruta": "/home/alan/Visual Studio Python/GeckoLauncher/GeckoLinks/geckolink_displaysettings.sh"
                },
                {
                    "consola": false,
                    "nombre": "geckolink_aparienciasettings.sh",
                    "ruta": "/home/alan/Visual Studio Python/GeckoLauncher/GeckoLinks/geckolink_aparienciasettings.sh"
                },
                {
                    "consola": false,
                    "nombre": "geckolink_terminal.sh",
                    "ruta": "/home/alan/Visual Studio Python/GeckoLauncher/GeckoLinks/geckolink_terminal.sh"
                },
                {
                    "consola": false,
                    "nombre": "geckolink_geckowallsettings.sh",
                    "ruta": "/home/alan/Visual Studio Python/GeckoLauncher/GeckoLinks/geckolink_geckowallsettings.sh"
                }
            ],
            "tema": {
                "color_texto": "#ffffff",
                "color_fondo_lista": "#000000",
                "color_fondo_item_activo": "#aaff7f",
        ...
        "SYSTEM": {
            "items": [
                ...
                {
                    "nombre": "geckolink_thunar.sh",
                    "ruta": "/home/alan/Visual Studio Python/GeckoLauncher/GeckoLinks/geckolink_thunar.sh",
                    "consola": false
                },
                {
                    "nombre": "geckolink_displaysettings.sh",
                ...
                {
                    "nombre": "geckolink_netsettings.sh",
                    "ruta": "/home/alan/Visual Studio Python/GeckoLauncher/GeckoLinks/geckolink_netsettings.sh",
                    "consola": false
                }
            ],
            "tema": {
                "color_texto": "#00ff88",
                "color_fondo_lista": "#000000",
                "color_fondo_item_activo": "#ff0000",
                "color_texto_item_activo": "#000000"
            }
        },
        "APPS": {
            "items": [
                ...
                {
                    "consola": false,
                    "nombre": "geckolink_gimp.sh",
                    "ruta": "/home/alan/Visual Studio Python/GeckoLauncher/GeckoLinks/geckolink_gimp.sh"
                },
                {
                    "consola": false,
                    "nombre": "geckolink_vscode.sh",
                    "ruta": "/home/alan/Visual Studio Python/GeckoLauncher/GeckoLinks/geckolink_vscode.sh"
                },
                {
                    "consola": false,
                    "nombre": "geckolink_calc.sh",
                    "ruta": "/home/alan/Visual Studio Python/GeckoLauncher/GeckoLinks/geckolink_calc.sh"
                },
                {
                    "consola": false,
                    "nombre": "geckolink_thunar.sh",
                ...
                {
                    "consola": false,
                    "nombre": "geckolink_firefox.sh",
                    "ruta": "/home/alan/Visual Studio Python/GeckoLauncher/GeckoLinks/geckolink_firefox.sh"
                },
                {
                    "consola": false,
                    "nombre": "geckolink_brave.sh",
                    "ruta": "/home/alan/Visual Studio Python/GeckoLauncher/GeckoLinks/geckolink_brave.sh"
                }
            ],
            "tema": {
                "color_texto": "#00ff88",
                "color_fondo_lista": "#000000",
                "color_fondo_item_activo": "#0000ff",
                "color_texto_item_activo": "#000000"
            }
        }
    }
...
"""
#Borrar o evaluar riesgos de seguridad antes de publicar en GitHub o copiar en cualquier pen drive [menos si es comprado por ecomerce]
...
# -------------------------------------------------------------------------------------------------------------------------------------------------------
geckoappversion = "v.5.7" # Geckonizado por LLamita Encendida y Depurado por NOva Pythoniza, HARCODEADO por Chaman Gecko y con la fisica Geckonica de Ei2
...
def get_version(easter_egg=False):
    ...
    # Colores ANSI estilo terminal fosforescente
    ...
    return f"""
        {G}
            ...
            {L}GECKOLAUNCKER {D}{geckoappversion}{R}
            {C}Core == Cuore by Team Cangurera{R}
            {A}ET COMPATIBLE CON PYLAND{R}
            {G}🦎Geckonismo™{R}
            {D}Artefacto 1997 // Berazategui // 2184{R}

            {G}Modular{R} • {A}Minimalista{R} • {C}Geckoniano{R} • {Y}Pleyadiano{R} • Monkey Python Coding Circus
...
class GeckoLauncker(QMainWindow):
    def __init__(self):
        super().__init__()
        self.offset = None
        self.setWindowTitle(f"🦎 Gecko Launcker Minimalista [3x4]{geckoappversion}")
        self.resize(720, 635)
        self.tamanio_geckotable = (QSize(237, 137))
        self.font_geckotable = 17  # ← TU VARIABLE GLOBAL DE LETRA
        self.geckoiconsize = (QSize(86, 86))

        # <<< VIENE MUCHA EXPLICACION PERO ES SOLO FISICA GECKONIANA >>>
    ...
    # -----------------------------------------------------
    '''#METODO ORIGINAL FUNCIONAL SIN FISICA
    def crear_pestana(self, nombre_categoria):
        ...
        nueva_lista.setMinimumSize(self.tamanio_geckotable) #Geckonico, elegante, con sentido y amor
    ...
    # --- Nueva Version con vision de Física Geckonica No Determinista ---
    '''
    def correccion_geckonica_gravedad(self, pos):
        """
        Neurona Adaptativa v.5.6 (Dialecto Nativo Qt).
        Consulta la brújula global 'posicionPestanasGecko' y decide
        si aplicar gravedad vertical o atracción magnética lateral.
        """
        ...
        # Modo gravitatorio: North(0) y South(1) -> El piso está abajo
        if posicionPestanasGecko in (QTabWidget.North, QTabWidget.South):
            return (columna, -fila)
            
        # Modo magnético: West(2) y East(3) -> El imán está en el costado
        else:
            return (fila, columna)
    ...
    def sincronizar_orden_lista(self, lista_widget):
        ...
        try:
            ...
            for i in range(lista_widget.count()):
                ...
                pos = lista_widget.visualItemRect(item).topLeft()
                data = item.data(Qt.UserRole)
                if data and not data.get("huevo"):
                    items_con_posicion.append((pos, data))

            # --- AQUI ESTA LA MAGIA: LA FÍSICA SE ADAPTA ON THE FLY ---
            items_ordenados = sorted(
                items_con_posicion, 
                key=lambda k: self.correccion_geckonica_gravedad(k[0])
            )
            # ----------------------------------------------------------

            nueva_data_items = [data for _, data in items_ordenados]
            self.config["categorias"][nombre_tab]["items"] = nueva_data_items
            
            lista_widget.clear()
            
            # Re-inyectamos el huevo de pascua
            ruta_hmx = os.path.join(self.scriptDir, "hmx.py")
            if os.path.exists(ruta_hmx):
                huevo = QListWidgetItem("🐣\n\nhmx.py")
                huevo.setData(Qt.UserRole, {"nombre": "hmx.py", "ruta": ruta_hmx, "consola": False, "huevo": True})
            ...
            print(f"❌ Error en la física adaptativa: {e}")
